...
Date.addLocale('zh-CN', {
  'variant': true,
  'monthSuffix': '月',
  'weekdays': '星期日|周日|星期天|周天|周末,星期一|周一,星期二|周二,星期三|周三,星期四|周四,星期五|周五,星期六|周六',
  'units': '毫秒,秒钟,分钟,小时,天,个星期|周,月|个月,年',
  'tokens': '日|号',
  ...
  'modifiers': [
    ...
    { 'name': 'sign', 'src': '前|之前', 'value': -1 },
    { 'name': 'sign', 'src': '后|之后', 'value':  1 },
    { 'name': 'edge',  'src': '末|底|结束', 'value': -1 },
    { 'name': 'edge',  'src': '初|开始', 'value': 1 },
    { 'name': 'shift', 'src': '上|去', 'value': -1 },
    { 'name': 'shift', 'src': '这|本|当', 'value':  0 },
    { 'name': 'shift', 'src': '下|明', 'value':  1 }
  ],
  'dateParse': [
    '{num}{unit}{sign}',
    '{shift}{unit=5-7?}{month?}{year?}{edge}',
    '{shift}{unit=5-7}',
    '{shift}{unit=6}{date}[日号]'
  ],
  'timeParse': [
    '{shift}{weekday}',
